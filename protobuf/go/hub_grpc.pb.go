...
type HubClient interface {
	...
	Resolve(ctx context.Context, in *StringValue, opts ...grpc.CallOption) (*Outputs, error)
}
...
func (c *hubClient) Resolve(ctx context.Context, in *StringValue, opts ...grpc.CallOption) (*Outputs, error) {
	out := new(Outputs)
...
type HubServer interface {
	...
	Resolve(context.Context, *StringValue) (*Outputs, error)
...
func (UnimplementedHubServer) Resolve(context.Context, *StringValue) (*Outputs, error) {
...
func _Hub_Resolve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HubServer).Resolve(ctx, req.(*StringValue))
	}
	return interceptor(ctx, in, info, handler)
}
